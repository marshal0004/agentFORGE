...
- This skill drives AUTONOMOUS execution — do NOT wait for user approval
- Execute all steps in sequence without pausing
- Use tools (write_file, execute_code, edit_file) to implement directly
- Only pause if you encounter a blocking error you cannot fix
